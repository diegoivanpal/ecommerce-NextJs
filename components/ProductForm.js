            ...
            <form onSubmit={saveProduct}>
                ...
                <input type="text" 
                    ...
                    {!!images?.length && images.map((link,i) => (
                        <div key={i} className=" h-24 w-24 bg-white p-4 shadow-sm rounded-sm border border-gray-200">
                    ...
                    {isUploadins && (
                        ...
                        <label className=" w-24 h-24 cursor-pointer text-center flex flex-col items-center justify-center text-sm gap-1 text-primary rounded-sm bg-white shadow-sm border border-gray-200 border-primary">
